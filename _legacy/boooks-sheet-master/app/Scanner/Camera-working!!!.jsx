    ...
    <div style={containerStyle}>
      <div style={openAnimationStyle(isOpen)}>
        ...
        <div style={topBarStyle}>
          <button onClick={handleClose} style={iconBtnStyle} className="shadow-lg active:scale-90 transition-transform">
            ✕
          </button>

          <div style={statusDotStyle(permission)} />
        </div>
        ...
        {(permission === "idle" || permission === "denied") && (
          <div style={centerUIStyle}>
            <button onClick={requestCamera} style={primaryBtnStyle} className="shadow-lg active:scale-90 transition-transform">
